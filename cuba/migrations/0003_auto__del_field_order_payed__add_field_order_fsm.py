...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.payed'
        db.delete_column('cuba_order', 'payed')

        # Adding field 'Order.fsm'
        db.add_column('cuba_order', 'fsm',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Order.payed'
        db.add_column('cuba_order', 'payed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Order.fsm'
        db.delete_column('cuba_order', 'fsm')
    ...
    models = {
        ...
        u'cuba.activity': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 10, 22, 0, 33, 3)'}),
