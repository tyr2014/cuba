...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.template_name'
        db.add_column(u'cuba_user_profile', 'template_name',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.template_info'
        db.add_column(u'cuba_user_profile', 'template_info',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)

        # Adding field 'Activity.template_name'
        db.add_column(u'cuba_activity', 'template_name',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'Activity.template_info'
        db.add_column(u'cuba_activity', 'template_info',
                      self.gf('django.db.models.fields.TextField')(default=u'', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserProfile.template_name'
        db.delete_column(u'cuba_user_profile', 'template_name')

        # Deleting field 'UserProfile.template_info'
        db.delete_column(u'cuba_user_profile', 'template_info')

        # Deleting field 'Activity.template_name'
        db.delete_column(u'cuba_activity', 'template_name')

        # Deleting field 'Activity.template_info'
        db.delete_column(u'cuba_activity', 'template_info')
    ...
    models = {
        ...
        u'cuba.activity': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 12, 16, 32, 22, 5)'}),
            ...
            'template_info': ('django.db.models.fields.TextField', [], {'default': "u''", 'blank': 'True'}),
            'template_name': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32', 'blank': 'True'}),
