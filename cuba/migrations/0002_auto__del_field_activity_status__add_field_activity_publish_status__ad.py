...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Activity.status'
        db.delete_column(u'cuba_activity', 'status')

        # Adding field 'Activity.publish_status'
        db.add_column(u'cuba_activity', 'publish_status',
    ...
    def backwards(self, orm):
        # Adding field 'Activity.status'
        db.add_column(u'cuba_activity', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Deleting field 'Activity.publish_status'
        db.delete_column(u'cuba_activity', 'publish_status')

        # Deleting field 'Activity.fsm'
        db.delete_column(u'cuba_activity', 'fsm')
