...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'cuba_user_profile', 'fullname')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.fullname'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.fullname' and its values cannot be restored.")
    models = {
        'auth.group': {
        ...
        u'cuba.activity': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 11, 12, 56, 40, 4)'}),
