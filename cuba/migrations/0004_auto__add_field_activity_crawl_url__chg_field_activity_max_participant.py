...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.crawl_url'
        db.add_column(u'cuba_activity', 'crawl_url',
                      self.gf('django.db.models.fields.CharField')(max_length=4096, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Activity.max_participants'
        db.alter_column(u'cuba_activity', 'max_participants', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'Activity.min_participants'
        db.alter_column(u'cuba_activity', 'min_participants', self.gf('django.db.models.fields.SmallIntegerField')())
    def backwards(self, orm):
        # Deleting field 'Activity.crawl_url'
        db.delete_column(u'cuba_activity', 'crawl_url')


        # Changing field 'Activity.max_participants'
        db.alter_column(u'cuba_activity', 'max_participants', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Activity.min_participants'
        db.alter_column(u'cuba_activity', 'min_participants', self.gf('django.db.models.fields.IntegerField')())
    models = {
        'auth.group': {
        ...
        u'cuba.activity': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 11, 12, 1, 50, 4)'}),
