...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.cancel_policy'
        db.alter_column(u'cuba_activity', 'cancel_policy_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cuba.CancelPolicy']))
    def backwards(self, orm):

        # Changing field 'Activity.cancel_policy'
        db.alter_column(u'cuba_activity', 'cancel_policy_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cuba.CancelPolicy'], null=True))
    models = {
        'auth.group': {
        ...
        u'cuba.activity': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 6, 8, 54, 19, 6)'}),
